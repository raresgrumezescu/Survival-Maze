...
namespace implemente
{
	...
	public:
		...
		//	position = glm::vec3(player.cap.x, player.cap.y, player.cap.z);
		...
		void RotateFirstPerson_OY(float angle)
		{
			...
			glm::mat4 rot_mat2 = glm::rotate(glm::mat4(1.f), angle, right);
			glm::vec4 new_rgt = glm::normalize(rot_mat2 * glm::vec4(right, 1));
			right = glm::vec3(new_rgt);
	...
	protected:
		float coordsCameraX = 0, coordsCameraY = 0, coordsCameraZ = 0;
	};
